      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
        <div>
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="font-display text-xl font-bold text-background">AnnaDaan</span>
          </div>
        ...
        <div>
          ...
          <div className="space-y-3 text-sm text-background/60">
            <div className="flex items-center gap-2"><Mail className="h-4 w-4 text-primary" /> info@annadaan.org</div>
            <div className="flex items-center gap-2"><Phone className="h-4 w-4 text-primary" /> +91 98765 43210</div>
            <div className="flex items-start gap-2"><MapPin className="h-4 w-4 text-primary mt-0.5" /> 123 Seva Marg, New Delhi, India 110001</div>
          </div>
        </div>
      </div>

      <div className="border-t border-background/10 mt-12 pt-8 text-center text-sm text-background/40">
        © {new Date().getFullYear()} AnnaDaan Foundation. All rights reserved. Made with ❤️ for India.
      </div>
    </div>
  </footer>
);
